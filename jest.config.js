...
module.exports = {
  ...
  setupFiles: ['<rootDir>/build-webpack/jest-settings/enzyme.config.js'],

  // Allowing jest-enzyme Library to insert itself into test process. Rather than Using Jest Test Environemt
